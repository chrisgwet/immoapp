    ...
    <div class="page-breadcrumb bg-white">
        <div class="row align-items-center">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title text-uppercase font-medium font-14">Nouvelle categorie</h4>
            </div>
        </div>
        <!-- /.col-lg-12 -->
    </div>
                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-material" method="post" action="{{ route('categories.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="col-md-12 border-bottom p-0">
                                    <input type="text" name="slug" value="{{ old('slug') }}" required placeholder="" class="form-control p-0 border-0 @error('slug') is-invalid @enderror">
                                    @error('slug')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="col-md-12 border-bottom p-0">
                                    <input type="file" id="property-image" name="image" required class="form-control p-0 border-0 @error('image') is-invalid @enderror">
                            ...
                            <div class="form-group mb-4">
                                <div class="col-sm-12">
                                    <button class="btn btn-primary">Creer la categorie</button>
                                </div>
                            </div>
                        </form>
                    </div>
