                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="row" style="margin-top: 70px;">
                                <div class="col-md-12">
                                    <a href="#"><img class="img-details" src="{{ asset('images/properties/'.$comment->property->image) }}" height="100" width="100"></a>
                                    @foreach($comment->property->images as $image)
                                        <a href="#"><img class="img-details" src="{{ asset('images/properties/'.$image->path) }}" height="100" width="100"></a>
                                    @endforeach
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <a href="{{ route('proprietes.show',$comment->property->id) }}"><img src="{{ asset('images/properties/'.$comment->property->image) }}" alt="" height="400" width="500" class="img-responsive img-main"></a>
                        </div>
                    </div>
                </div>
            </div>
